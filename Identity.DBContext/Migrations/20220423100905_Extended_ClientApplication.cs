...
{
  public partial class Extended_ClientApplication : Migration
  {
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          name: "open_iddict_client_application",
          schema: "public",
          columns: table => new
          {
          ...
          constraints: table =>
          {
            table.PrimaryKey("pk_open_iddict_client_application", x => x.id);
          });

      migrationBuilder.CreateTable(
          name: "open_iddict_client_scope",
          schema: "public",
          columns: table => new
          {
            id = table.Column<string>(type: "text", nullable: false),
          ...
          constraints: table =>
          {
            table.PrimaryKey("pk_open_iddict_client_scope", x => x.id);
          });

      migrationBuilder.CreateTable(
          name: "open_iddict_client_authorization",
          schema: "public",
          columns: table => new
          {
            id = table.Column<string>(type: "text", nullable: false),
          ...
          constraints: table =>
          {
            table.PrimaryKey("pk_open_iddict_client_authorization", x => x.id);
            table.ForeignKey(
                      name: "fk_open_iddict_client_authorization_open_iddict_client_applica",
      ...
      migrationBuilder.CreateTable(
          ...
          constraints: table =>
          {
            table.PrimaryKey("pk_open_iddict_client_token", x => x.id);
            table.ForeignKey(
                      name: "fk_open_iddict_client_token_open_iddict_client_application_app",
                      column: x => x.application_id,
                      principalSchema: "public",
                      principalTable: "open_iddict_client_application",
                      principalColumn: "id");
            table.ForeignKey(
                      name: "fk_open_iddict_client_token_open_iddict_client_authorization_a",
                      column: x => x.authorization_id,
                      principalSchema: "public",
                      principalTable: "open_iddict_client_authorization",
                      principalColumn: "id");
          });

      migrationBuilder.CreateIndex(
          name: "ix_open_iddict_client_application_client_id",
          schema: "public",
      ...
      migrationBuilder.CreateIndex(
          name: "ix_open_iddict_client_authorization_application_id_status_subj",
          schema: "public",
          table: "open_iddict_client_authorization",
          columns: new[] { "application_id", "status", "subject", "type" });

      migrationBuilder.CreateIndex(
          name: "ix_open_iddict_client_scope_name",
          schema: "public",
          table: "open_iddict_client_scope",
          column: "name",
          unique: true);

      migrationBuilder.CreateIndex(
          name: "ix_open_iddict_client_token_application_id_status_subject_type",
          schema: "public",
          table: "open_iddict_client_token",
          columns: new[] { "application_id", "status", "subject", "type" });

      migrationBuilder.CreateIndex(
          name: "ix_open_iddict_client_token_authorization_id",
          schema: "public",
          table: "open_iddict_client_token",
          column: "authorization_id");

      migrationBuilder.CreateIndex(
          name: "ix_open_iddict_client_token_reference_id",
          schema: "public",
          table: "open_iddict_client_token",
          column: "reference_id",
          unique: true);
