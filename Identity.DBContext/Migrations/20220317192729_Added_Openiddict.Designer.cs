...
namespace Identity.DBContext.Migrations
{
    ...
    [Migration("20220317192729_Added_Openiddict")]
    partial class Added_Openiddict
    {
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_open_iddict_entity_framework_core_application");

                    b.HasIndex("ClientId")
                        .IsUnique()
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_application_client_id");

                    b.ToTable("open_iddict_entity_framework_core_application", "public");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_open_iddict_entity_framework_core_authorization");

                    b.HasIndex("ApplicationId", "Status", "Subject", "Type")
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_authorization_application");

                    b.ToTable("open_iddict_entity_framework_core_authorization", "public");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreScope", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_open_iddict_entity_framework_core_scope");

                    b.HasIndex("Name")
                        .IsUnique()
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_scope_name");

                    b.ToTable("open_iddict_entity_framework_core_scope", "public");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreToken", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_open_iddict_entity_framework_core_token");

                    b.HasIndex("AuthorizationId")
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_token_authorization_id");

                    b.HasIndex("ReferenceId")
                        .IsUnique()
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_token_reference_id");

                    b.HasIndex("ApplicationId", "Status", "Subject", "Type")
                        .HasDatabaseName("ix_open_iddict_entity_framework_core_token_application_id_stat");

                    b.ToTable("open_iddict_entity_framework_core_token", "public");
                });
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization", b =>
                {
                    b.HasOne("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication", "Application")
                        ...
                        .HasConstraintName("fk_open_iddict_entity_framework_core_authorization_open_iddict");
            ...
            modelBuilder.Entity("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreToken", b =>
                {
                    b.HasOne("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreApplication", "Application")
                        .WithMany("Tokens")
                        .HasForeignKey("ApplicationId")
                        .HasConstraintName("fk_open_iddict_entity_framework_core_token_open_iddict_entity_");

                    b.HasOne("OpenIddict.EntityFrameworkCore.Models.OpenIddictEntityFrameworkCoreAuthorization", "Authorization")
                        .WithMany("Tokens")
                        .HasForeignKey("AuthorizationId")
                        .HasConstraintName("fk_open_iddict_entity_framework_core_token_open_iddict_entity_1");
